...
export default function DashboardPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">今日複習</h1>
        <p className="text-gray-500 text-sm mt-1">保持每日練習，記憶更牢固</p>
      </div>
      ...
      {vocabularies.length === 0 && (
        <div className="text-center py-12 text-gray-400">
          ...
          <Link href="/vocabulary/new" className="text-indigo-600 text-sm mt-1 inline-block hover:underline">
            新增第一個單字 →
          </Link>
        </div>
      )}
